      ...
      <main>
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 pt-14 pb-16 sm:pt-20 sm:pb-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-4 text-label text-gray-400">Free plan forever · No credit card required</p>
          </div>
        </section>
        ...
        <section style={{ borderTop: '1px solid #e5e7eb', borderBottom: '1px solid #e5e7eb' }}>
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="grid grid-cols-1 sm:grid-cols-2" style={{ gap: 0 }}>
              <div className="flex items-center gap-4 py-6 sm:pr-8" style={{ borderBottom: '1px solid #e5e7eb' }}>
                <div
                ...
                <div>
                  <p className="text-label font-semibold text-gray-400 uppercase mb-0.5">F5Bot</p>
                  <p className="text-sm font-medium text-gray-500">Tells you when you&rsquo;re mentioned</p>
                </div>
              </div>
              <div
                className="flex items-center gap-4 py-6 sm:pl-8"
                style={{ borderBottom: '1px solid #e5e7eb', borderLeft: '1px solid #e5e7eb' }}
              >
                <div
                  className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-xl"
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-800">Tells you when someone wants to buy</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div>
                ...
                <p className="text-body-lg text-gray-500 mb-4">
                  F5Bot was built in 2014 as a free personal project. It does exactly what it promises — it watches Reddit and emails you every time your keyword appears. The problem is <em className="text-gray-600 not-italic">every</em> time. No filtering, no scoring, no way to tell a curious lurker from someone ready to hand over their credit card.
                </p>
                <p className="text-body-lg text-gray-500 mb-4">
              ...
              <div style={{ ...cardHi, borderRadius: '16px' }} className="p-6 space-y-4">
                <p className="text-label font-bold text-gray-400 uppercase">Why teams leave F5Bot</p>
                {[
        ...
        {/* ── HOW RADARSCOUT FIXES IT ── */}
        <section className="py-14 sm:py-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              <h2 className="text-h2 font-bold text-gray-900">How RadarScout is different</h2>
        ...
        <section className="py-14 sm:py-20" style={{ background: '#f9fafb' }}>
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-10">
              <h2 className="text-h2 font-bold text-gray-900">F5Bot vs RadarScout — side by side</h2>
            </div>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr style={{ borderBottom: '1px solid #e5e7eb' }}>
                        ...
                        <th className="px-5 sm:px-6 py-4 font-medium text-gray-400 text-center">F5Bot</th>
                        ...
                        <tr key={feature} style={{ borderBottom: '1px solid #f3f4f6' }}>
                          ...
                          <td className="px-5 sm:px-6 py-3.5 text-center">
                            {typeof f5bot === 'boolean' ? (
                              ...
                              <span className="text-gray-400">{f5bot}</span>
                            )}
                          </td>
                          <td className="px-5 sm:px-6 py-3.5 text-center">
                            {typeof us === 'boolean' ? (
