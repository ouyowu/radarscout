          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            {isLoggedIn ? (
              ...
              <>
                ...
                <Link
                  href="/auth/register"
                  className="text-sm font-semibold bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg transition-colors min-h-[44px] flex items-center focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2"
                >
                  Get started free
                </Link>
              </>
