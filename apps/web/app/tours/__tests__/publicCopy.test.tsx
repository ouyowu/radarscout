...
describe('tour public copy safety', () => {
  ...
  it('renders the first 12 reviewed Viator products with safe copy and pagination', async () => {
    ...
    expect(markup).toContain('We narrow the list before you browse')
    expect(markup).toContain('Why it made the shortlist')
    expect(markup).toContain('Current price, inclusions, and booking terms stay on Viator')
    expect(markup).not.toMatch(/\bcheapest\b|lowest price|best[- ]selling|sales rank/i)
