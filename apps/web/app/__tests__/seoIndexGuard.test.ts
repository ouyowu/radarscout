...
const CURRENT_INDEXABLE_SITEMAP_URLS = [
  ...
  `${BASE}/guides/bangkok/canals-vs-chinatown-evening`,
  `${BASE}/guides/chiang-mai/how-to-choose-an-elephant-sanctuary`,
  `${BASE}/guides/chiang-mai/doi-inthanon-vs-chiang-rai-day-trip`,
  `${BASE}/guides/chiang-mai/old-city-vs-nimman-where-to-stay`,
  `${BASE}/guides/chiang-mai/doi-suthep-vs-mae-kampong-half-day`,
  `${BASE}/guides/phuket/phi-phi-vs-james-bond-island`,
  `${BASE}/guides/phuket/old-town-vs-island-day`,
  `${BASE}/guides/phuket/private-vs-shared-island-tour`,
  `${BASE}/guides/phuket/beach-day-vs-boat-day-short-stay`,
