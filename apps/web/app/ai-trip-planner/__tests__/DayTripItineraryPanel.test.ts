...
describe('DayTripItineraryPanel', () => {
  it('renders an honest day-tour sequence without commerce or transport claims', () => {
    ...
    expect(source).toContain('handoffContext: SafeAffiliateAnalyticsContext')
    expect(source).toContain('buildAiTripPlannerDetailHref(day.experience.detailHref, day.experience.productId, handoffContext)')
