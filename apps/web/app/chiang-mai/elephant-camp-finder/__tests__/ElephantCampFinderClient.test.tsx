...
describe('ElephantCampFinderClient view model', () => {
  ...
  it('instruments existing finder funnel interactions without adding network, booking, or availability behavior', () => {
    ...
    expect(finderClientSource).toContain("track('finder_recommendations_rendered'")
    expect(finderClientSource).toContain("track('booking_partner_handoff_clicked'")
    expect(finderClientSource).toContain('productId: recommendation.recommendationId')
    expect(finderClientSource).toContain('resultPosition')
    expect(finderClientSource).toContain("provider: 'bokun'")
    expect(finderClientSource).toContain("placement: 'planner_filtered_matches'")
